...
$verificaUser = mysqli_query($conectar, "SELECT * FROM user WHERE user_id = '$LogSessionId'");
 ...
 if($userid == $LogSessionId && $login == $LogSessionLogin && $senha == $logSessionSenha && $nivel == 'arquivo'){

 }else{
 echo 'Acesso Restrito ao Arquivo <a href="../index.php">Clique aqui para Logar</a>';
 die;
 }
