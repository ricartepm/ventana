...
<div id="header">
 ...
 try{
	 $query_inboxAdmin = $conecta->prepare($sql_pegaAtivos);
     ...
     <tr align="center" <?PHP echo $cor;?>>
      <td ><?php 
	   $qrproce = "SELECT * FROM processo WHERE ID = '$proce_id_processo'";
           $stproce = mysqli_query($qrproce)or die (mysqli_errno());
      ...
      <td><a href="#" onclick="MM_openBrWindow('imprimir.php?caixa=<?php echo $proce_caixa ; ?>','','menubar=yes,width=450,height=900')">Imprimir</a></td>
    </tr>
