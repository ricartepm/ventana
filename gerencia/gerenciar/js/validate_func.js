$(document).ready(function(){
  ...
  $("#caixa2").validate({
	...
	rules:{
        ...
        prateleira:{required: true, minlength:8, maxlength:8}
        ...
        prateleira:{required: "Encha o campo Prateleira", minlength: "Deve ter exatamente 8 Caracteres ex: IAB-1V-2", maxlength: "Deve ter exatamente 8 Caracteres ex: IAB-1V-2"}
