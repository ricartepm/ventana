<?php if(isset($LogSessionId) && $LogSessionId != ''){
 ...
 if($userid == $LogSessionId && $login == $LogSessionLogin && $senha == $logSessionSenha && $nivel == 'gerencia'){

 }else{
 echo 'Acesso Restrito ao Gerencia <a href="../index.php">Clique aqui para Logar</a>';
 die;
 }
