...
//  $theValue = function_exists("mysqli_real_escape_string") ? mysqli_real_escape_string($theValue) : mysqli_escape_string($conectar, $theValue);
...
<form action="<?php echo $editFormAction; ?>" method="post" name="solicitar" id="solicitar" enctype="multipart/form-data">
    ...
    <tr>
	  ...
	  <option value="Motivo não selecionado"> Selecione motivo da solicitação </option>
         <option value="Fiscal" id="fical"> Fiscal</option>
         <option value="Auditoria" id="auditoria"> Auditoria</option> 
         <option value="Consulta da Área" id="Consulta da Área"> Consulta da Área</option> 
    ...
    <tr>
      <td >&nbsp;</td>
      <td>
          <input type="submit"  name="solicitar" id="solicitar" value="Solicitar" onclick="this.disabled=true; this.form.submit(); this.value='enviando...'" class="btn" /></td>
   </tr>
  </table>
