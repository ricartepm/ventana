...
<?php if (isset ($_POST['add_resposta'])){
	...
	$stUpdateRead  = mysqli_query($qrUpdateRead)or die (mysqli_errno());
	$response = 'ok';
   ...
   $msGet = mysqli_real_escape_string($_GET['ms']);  
   $qrms  = " SELECT * FROM solicitacao WHERE id_solicitacao= '$msGet' AND id_solicitacao = '$msGet'";
