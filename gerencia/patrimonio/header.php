...
<?php require_once('../restrito_gerencia.php'); ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="menu" >
            ...
            <a href="../index.php?pagina=home"><li>Arquivo</li></a>
            <a href="../gerenciar/"><li>Gerenciador Arquivo</li></a>
            <a href="index.php"><li>Patrimonio</li></a>
         ...
         <div id="central">
             ...
             <form name="processo" action="index.php?pagina=computador" enctype="multipart/form-date" method="post">
